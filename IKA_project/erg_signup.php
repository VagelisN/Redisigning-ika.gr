	...
	<div class="container">
		<div class="row" style="height: 35px; width: 40%; padding:0;">
			<ul class="breadcrumb" style="background-color: white;">
				...
				<li class="active">Εγγραφή ως εργοδότης</li>
			</ul>
		</div>
		<div class ="jumbotron" id="jum" style="background-color: white; margin: 0; padding: 0;">
		<div class="row">
			<h3 class="text-center">Για την εγγραφή ως Εργοδότης συμπληρώστε τις παρακάτω πληροφόρίες:</h3>
			<?php
					$fullUrl = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
					if (strpos($fullUrl, "signup=afm_doesnt_exists"))
					{
						echo '<h3 class="text-center" style="color: red; padding-bottom: 15px;" >Δεν υπάρχει εργοδότης με αυτό το Α.Φ.Μ.!</h3>';
					}
					elseif (strpos($fullUrl, "signup=erg_username_exists"))
					{
						echo '<h3 class="text-center" style="color: red; padding-top: 15px;" >Υπάρχει ήδη λογαριασμός εργοδότη με αυτό το username!</h3>';
					}
	        ...
	        <div class="col-md-6 col-md-offset-3" style="margin-top: 25px;">
	            <form action="background/erg_signup_form_background.php" method="post" role="form" id="signup_form">
	            <fieldset>
